            ...
            delete from "Elementary"."elementary"."dbt_sources"
            where (
                unique_id) in (
                select (unique_id)
                from "Elementary"."elementary"."dbt_sources__dbt_tmp"
            )
